...
// /api/poll's notifyWatchers), just fanned out to the whole user base
...
// already uses.
export async function sendBroadcast(subject: string, message: string): Promise<BroadcastResult> {
  await requireAdmin();
