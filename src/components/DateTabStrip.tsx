      ...
      {dates.map((d) => {
        ...
        return (
          <button
            ...
            className="flex h-20 min-w-16 shrink-0 flex-col items-center justify-center gap-0.5 rounded-2xl transition-[background-color,color,transform] duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 active:scale-[0.96]"
            style={
              isSelected
